...
export async function getContact(id?: string): Promise<Nullable<ContactType>> {
...
export async function updateContact(id?: string, updates?: ContactType): Promise<ContactType> {
	await fakeNetwork();
